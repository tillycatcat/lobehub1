export default {
  ...
  'agentDocuments.applySuccess': 'Template applied successfully',
  'agentDocuments.applyTemplate': 'Apply Template',
  'agentDocuments.delete': 'Delete',
  'agentDocuments.deleteConfirm': 'Delete this document?',
  'agentDocuments.deleteSuccess': 'Document deleted',
  'agentDocuments.desc': 'Manage agent-scoped documents and initialize from a template.',
